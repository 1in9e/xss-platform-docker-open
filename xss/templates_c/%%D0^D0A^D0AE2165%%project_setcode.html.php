<?php /* Smarty version 2.6.26, created on 2016-01-26 01:21:40
...
" style="display:none">
                <li style="list-style:none">参数:<br /><pre><?php echo $this->_tpl_vars['v']['keys']; ?>
</pre></li>
                <li style="list-style:none">代码:<br /><pre><?php echo $this->_tpl_vars['v']['code']; ?>
</pre></li>
            </ul>
            </li>
            <?php endforeach; endif; unset($_from); ?>
